...
summary['Base table']                               = params.basetable
summary['Inclusion dir']                            = params.inclusion
...
inclusion_ch = Channel.fromPath(params.inclusion)

workflow {

  masterTable = GenerateMasterTable(input_ch, inclusion_ch)
